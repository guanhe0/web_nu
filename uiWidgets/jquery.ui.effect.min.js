(function(c,w){c.effects={effect:{}};(function(c,h){function b(f,a,c){var b=s[a.type]||{};if(null==f)return c||!a.def?null:a.def;f=b.floor?~~f:parseFloat(f);return isNaN(f)?a.def:b.mod?(f+b.mod)%b.mod:0>f?0:b.max<f?b.max:f}function a(f){var a=g(),b=a._rgba=[];f=f.toLowerCase();p(l,function(c,d){var e,g=d.re.exec(f);e=g&&d.parse(g);g=d.space||"rgba";if(e)return e=a[g](e),a[m[g].cache]=e[m[g].cache],b=a._rgba=e._rgba,!1});return b.length?("0,0,0,0"===b.join()&&c.extend(b,u.transparent),a):u[f]}function d(f,
a,b){b=(b+1)%1;return 1>6*b?f+(a-f)*b*6:1>2*b?a:2>3*b?f+(a-f)*(2/3-b)*6:f}var e=/^([\-+])=\s*(\d+\.?\d*)/,l=[{re:/rgba?\(\s*(\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(\d{1,3})\s*(?:,\s*(\d?(?:\.\d+)?)\s*)?\)/,parse:function(f){return[f[1],f[2],f[3],f[4]]}},{re:/rgba?\(\s*(\d+(?:\.\d+)?)\%\s*,\s*(\d+(?:\.\d+)?)\%\s*,\s*(\d+(?:\.\d+)?)\%\s*(?:,\s*(\d?(?:\.\d+)?)\s*)?\)/,parse:function(f){return[2.55*f[1],2.55*f[2],2.55*f[3],f[4]]}},{re:/#([a-f0-9]{2})([a-f0-9]{2})([a-f0-9]{2})/,parse:function(f){return[parseInt(f[1],
16),parseInt(f[2],16),parseInt(f[3],16)]}},{re:/#([a-f0-9])([a-f0-9])([a-f0-9])/,parse:function(f){return[parseInt(f[1]+f[1],16),parseInt(f[2]+f[2],16),parseInt(f[3]+f[3],16)]}},{re:/hsla?\(\s*(\d+(?:\.\d+)?)\s*,\s*(\d+(?:\.\d+)?)\%\s*,\s*(\d+(?:\.\d+)?)\%\s*(?:,\s*(\d?(?:\.\d+)?)\s*)?\)/,space:"hsla",parse:function(f){return[f[1],f[2]/100,f[3]/100,f[4]]}}],g=c.Color=function(f,a,b,d){return new c.Color.fn.parse(f,a,b,d)},m={rgba:{props:{red:{idx:0,type:"byte"},green:{idx:1,type:"byte"},blue:{idx:2,
type:"byte"}}},hsla:{props:{hue:{idx:0,type:"degrees"},saturation:{idx:1,type:"percent"},lightness:{idx:2,type:"percent"}}}},s={"byte":{floor:!0,max:255},percent:{max:1},degrees:{mod:360,floor:!0}},x=g.support={},r=c("<p>")[0],u,p=c.each;r.style.cssText="background-color:rgba(1,1,1,.5)";x.rgba=-1<r.style.backgroundColor.indexOf("rgba");p(m,function(f,a){a.cache="_"+f;a.props.alpha={idx:3,type:"percent",def:1}});g.fn=c.extend(g.prototype,{parse:function(f,d,e,n){if(f===h)return this._rgba=[null,null,
null,null],this;if(f.jquery||f.nodeType)f=c(f).css(d),d=h;var k=this,t=c.type(f),l=this._rgba=[];d!==h&&(f=[f,d,e,n],t="array");if("string"===t)return this.parse(a(f)||u._default);if("array"===t)return p(m.rgba.props,function(a,c){l[c.idx]=b(f[c.idx],c)}),this;if("object"===t)return f instanceof g?p(m,function(a,b){f[b.cache]&&(k[b.cache]=f[b.cache].slice())}):p(m,function(a,d){var e=d.cache;p(d.props,function(a,c){if(!k[e]&&d.to){if("alpha"===a||null==f[a])return;k[e]=d.to(k._rgba)}k[e][c.idx]=b(f[a],
c,!0)});k[e]&&0>c.inArray(null,k[e].slice(0,3))&&(k[e][3]=1,d.from&&(k._rgba=d.from(k[e])))}),this},is:function(a){var b=g(a),c=!0,d=this;p(m,function(a,f){var e,g=b[f.cache];g&&(e=d[f.cache]||f.to&&f.to(d._rgba)||[],p(f.props,function(a,f){if(null!=g[f.idx])return c=g[f.idx]===e[f.idx]}));return c});return c},_space:function(){var a=[],b=this;p(m,function(c,d){b[d.cache]&&a.push(c)});return a.pop()},transition:function(a,c){var d=g(a),e=d._space(),k=m[e],h=0===this.alpha()?g("transparent"):this,
l=h[k.cache]||k.to(h._rgba),v=l.slice(),d=d[k.cache];p(k.props,function(a,f){var e=f.idx,n=l[e],g=d[e],k=s[f.type]||{};null!==g&&(null===n?v[e]=g:(k.mod&&(g-n>k.mod/2?n+=k.mod:n-g>k.mod/2&&(n-=k.mod)),v[e]=b((g-n)*c+n,f)))});return this[e](v)},blend:function(a){if(1===this._rgba[3])return this;var b=this._rgba.slice(),d=b.pop(),e=g(a)._rgba;return g(c.map(b,function(a,f){return(1-d)*e[f]+d*a}))},toRgbaString:function(){var a="rgba(",b=c.map(this._rgba,function(a,b){return null==a?2<b?1:0:a});1===
...
g.fn;m.hsla.to=function(a){if(null==a[0]||null==a[1]||null==a[2])return[null,null,null,a[3]];var b=a[0]/255,d=a[1]/255,c=a[2]/255;a=a[3];var e=Math.max(b,d,c),g=Math.min(b,d,c),h=e-g,l=e+g,m=0.5*l,l=0===h?0:0.5>=m?h/l:h/(2-l);return[Math.round(g===e?0:b===e?60*(d-c)/h+360:d===e?60*(c-b)/h+120:60*(b-d)/h+240)%360,l,m,null==a?1:a]};m.hsla.from=function(a){if(null==a[0]||null==a[1]||null==a[2])return[null,null,null,a[3]];var b=a[0]/360,c=a[1],e=a[2];a=a[3];c=0.5>=e?e*(1+c):e+c-e*c;e=2*e-c;return[Math.round(255*
...
{expand:function(a){var b={};p(["Top","Right","Bottom","Left"],function(d,e){b["border"+e+"Color"]=a});return b}};u=c.Color.names={aqua:"#00ffff",black:"#000000",blue:"#0000ff",fuchsia:"#ff00ff",gray:"#808080",green:"#008000",lime:"#00ff00",maroon:"#800000",navy:"#000080",olive:"#808000",purple:"#800080",red:"#ff0000",silver:"#c0c0c0",teal:"#008080",white:"#ffffff",yellow:"#ffff00",transparent:[null,null,null,0],_default:"#ffffff"}})(jQuery);(function(){function q(a){var b,e=a.ownerDocument.defaultView?
...
a.end&&!a.setAttr||1===a.pos&&!a.setAttr)jQuery.style(a.elem,b,a.end),a.setAttr=!0}});c.fn.addBack||(c.fn.addBack=function(a){return this.add(null==a?this.prevObject:this.prevObject.filter(a))});c.effects.animateClass=function(a,d,e,l){var g=c.speed(d,e,l);return this.queue(function(){var d=c(this),e=d.attr("class")||"",l,r=g.children?d.find("*").addBack():d,r=r.map(function(){return{el:c(this),start:q(this)}});l=function(){c.each(h,function(b,c){if(a[c])d[c+"Class"](a[c])})};l();r=r.map(function(){this.end=
...
e,h,g){return e?c.effects.animateClass.call(this,{add:b},e,h,g):a.apply(this,arguments)}}(c.fn.addClass),removeClass:function(a){return function(b,e,h,g){return 1<arguments.length?c.effects.animateClass.call(this,{remove:b},e,h,g):a.apply(this,arguments)}}(c.fn.removeClass),toggleClass:function(a){return function(b,e,h,g,m){return"boolean"===typeof e||e===w?h?c.effects.animateClass.call(this,e?{add:b}:{remove:b},h,g,m):a.apply(this,arguments):c.effects.animateClass.call(this,{toggle:b},e,h,g)}}(c.fn.toggleClass),
switchClass:function(a,b,e,h,g){return c.effects.animateClass.call(this,{add:b,remove:a},e,h,g)}})})();(function(){function q(b,a,d,e){c.isPlainObject(b)&&(a=b,b=b.effect);b={effect:b};null==a&&(a={});c.isFunction(a)&&(e=a,d=null,a={});if("number"===typeof a||c.fx.speeds[a])e=d,d=a,a={};c.isFunction(d)&&(e=d,d=null);a&&c.extend(b,a);d=d||a.duration;b.duration=c.fx.off?0:"number"===typeof d?d:d in c.fx.speeds?c.fx.speeds[d]:c.fx.speeds._default;b.complete=e||a.complete;return b}function h(b){return!b||
