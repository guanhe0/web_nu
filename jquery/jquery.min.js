(function(r, n) {
    ...
    function bb(a, b) {
        if (1 === b.nodeType && c.hasData(a)) {
            ...
            h) for (e = 0, f = h[d].length; e < f; e++) c.event.add(b, d, h[d][e]);
    ...
    function eb(a, b) {
        for (var d, e, f, g = [], h = 0, k = a.length; h < k; h++) e = a[h],
        e.style && (g[h] = c._data(e, "olddisplay"), d = e.style.display, b ? (g[h] || "none" !== d || (e.style.display = ""), "" === e.style.display && P(e) && (g[h] = c._data(e, "olddisplay", fb(e.nodeName)))) : g[h] || (f = P(e), (d && "none" !== d || !f) && c._data(e, "olddisplay", f ? d: c.css(e, "display"))));
        for (h = 0; h < k; h++) e = a[h],
    ...
    function hb(a, b, d, e, f) {
        ...
        for (var g = 0; 4 > b; b += 2)"margin" === d && (g += c.css(a, d + Q[b], !0, f)),
        e ? ("content" === d && (g -= c.css(a, "padding" + Q[b], !0, f)), "margin" !== d && (g -= c.css(a, "border" + Q[b] + "Width", !0, f))) : (g += c.css(a, "padding" + Q[b], !0, f), "padding" !== d && (g += c.css(a, "border" + Q[b] + "Width", !0, f)));
        return g
    }
    function ib(a, b, d) {
        var e = !0,
    ...
    function fb(a) {
        var b = p,
        d = jb[a];
        d || (d = kb(a, b), "none" !== d && d || (ea = (ea || c("<iframe frameborder='0' width='0' height='0'/>").css("cssText", "display:block !important")).appendTo(b.documentElement), b = (ea[0].contentWindow || ea[0].contentDocument).document, b.write("<!doctype html><html><body>"), b.close(), d = kb(a, b), ea.detach()), jb[a] = d);
        return d
    }
    function kb(a, b) {
    ...
    function Aa(a, b, d, e) {
        ...
        else for (f in b) Aa(a + "[" + f + "]", b[f], d, e)
    }
    function lb(a) {
        return function(b, d) {
    ...
    function mb(a, b, d, e) {
        function f(k) {
            ...
            function(a, c) {
                var k = c(b, d, e);
                if ("string" === typeof k && !h && !g[k]) return b.dataTypes.unshift(k),
                f(k),
                !1;
                if (h) return ! (l = k)
            });
    ...
    function pb(a, b, d) {
        ...
        k = function() {
            if (e) return ! 1;
            for (var b = T || ob(), b = Math.max(0, l.startTime + l.duration - b), c = 1 - (b / l.duration || 0), d = 0, f = l.tweens.length; d < f; d++) l.tweens[d].run(c);
    ...
    function Zb(a, b) {
        var d, e, f, g, h;
        for (f in a) if (e = c.camelCase(f), g = b[e], d = a[f], c.isArray(d) && (g = d[1], d = a[f] = d[0]), f !== e && (a[e] = d, delete a[f]), (h = c.cssHooks[e]) && "expand" in h) for (f in d = h.expand(d), delete a[e], d) f in a || (a[f] = d[f], b[f] = g);
        else b[e] = g
    }
    ...
    L = function(a) {
        if (p.addEventListener || "load" === a.type || "complete" === p.readyState) vb(),
        c.ready()
    },
    vb = function() {
    ...
    c.fn = c.prototype = {
        ...
        init: function(a, b, d) {
            ...
            if (!a) return this;
            if ("string" === typeof a) {
                e = "<" === a.charAt(0) && ">" === a.charAt(a.length - 1) && 3 <= a.length ? [null, a, null] : ec.exec(a);
                if (!e || !e[1] && b) return ! b || b.jquery ? (b || d).find(a) : this.constructor(b).find(a);
                if (e[1]) {
                    if (b = b instanceof c ? b[0] : b, c.merge(this, c.parseHTML(e[1], b && b.nodeType ? b.ownerDocument || b: p, !0)), ub.test(e[1]) && c.isPlainObject(b)) for (e in b) if (c.isFunction(this[e])) this[e](b[e]);
    ...
    c.extend = c.fn.extend = function() {
        ...
        k === h && (g = this, --h);
        for (; h < k; h++) if (null != (f = arguments[h])) for (e in f) a = g[e],
        d = f[e],
        g !== d && (l && d && (c.isPlainObject(d) || (b = c.isArray(d))) ? (b ? (b = !1, a = a && c.isArray(a) ? a: []) : a = a && c.isPlainObject(a) ? a: {},
        g[e] = c.extend(l, a, d)) : d !== n && (g[e] = d));
        return g
    };
    c.extend({
        ...
        ready: function(a) {
            if (!0 === a ? !--c.readyWait: !c.isReady) {
                ...
                c.isReady = !0; ! 0 !== a && 0 < --c.readyWait || (la.resolveWith(p, [c]), c.fn.trigger && c(p).trigger("ready").off("ready"))
            }
        },
        ...
        type: function(a) {
            return null == a ? String(a) : "object" === typeof a || "function" === typeof a ? ma[cc.call(a)] || "object": typeof a
        },
        ...
        each: function(a, b, c) {
            ...
            g = a.length;
            e = va(a);
            if (c) if (e) for (; f < g && (e = b.apply(a[f], c), !1 !== e); f++);
            else for (f in a) {
        ...
        access: function(a, b, d, e, f, g, h) {
            ...
            else if (e !== n && (f = !0, c.isFunction(e) || (h = !0), q && (h ? (b.call(a, e), b = null) : (q = b, b = function(a, b, d) {
                return q.call(c(a), d)
    ...
    c.ready.promise = function(a) {
        if (!la) if (la = c.Deferred(), "complete" === p.readyState) setTimeout(c.ready);
        else if (p.addEventListener) p.addEventListener("DOMContentLoaded", L, !1),
    ...
    c.Callbacks = function(a) {
        a = "string" === typeof a ? Sa[a] || Qb(a) : c.extend({},
        a);
        var b, d, e, f, g, h, k = [],
        l = !a.once && [],
        q = function(c) {
        ...
        s = {
            ...
            fireWith: function(a, c) {
                c = c || [];
                c = [a, c.slice ? c.slice() : c]; ! k || e && !l || (b ? l.push(c) : q(c));
                return this
            },
            fire: function() {
    ...
    c.support = function() {
        ...
        a[h + "Bubbles"] = d in r || !1 === k.attributes[d].expando;
        ...
        c(function() {
            ...
            d && (b = p.createElement("div"), b.style.cssText = "border:0;width:0;height:0;position:absolute;top:0;left:-9999px;margin-top:1px", d.appendChild(b).appendChild(k), k.innerHTML = "<table><tr><td></td><td>t</td></tr></table>", c = k.getElementsByTagName("td"), c[0].style.cssText = "padding:0;margin:0;border:0;display:none", g = 0 === c[0].offsetHeight, c[0].style.display = "", c[1].style.display = "none", a.reliableHiddenOffsets = g && 0 === c[0].offsetHeight, k.innerHTML = "", k.style.cssText = "box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;padding:1px;border:1px;display:block;width:4px;margin-top:1%;position:absolute;top:1%;", a.boxSizing = 4 === k.offsetWidth, a.doesNotIncludeMarginInBodyOffset = 1 !== d.offsetTop, r.getComputedStyle && (a.pixelPosition = "1%" !== (r.getComputedStyle(k, null) || {}).top, a.boxSizingReliable = "4px" === (r.getComputedStyle(k, null) || {
                width: "4px"
            }).width, c = k.appendChild(p.createElement("div")), c.style.cssText = k.style.cssText = "padding:0;margin:0;border:0;display:block;box-sizing:content-box;-moz-box-sizing:content-box;-webkit-box-sizing:content-box;", c.style.marginRight = c.style.width = "0", k.style.width = "1px", a.reliableMarginRight = !parseFloat((r.getComputedStyle(c, null) || {}).marginRight)), typeof k.style.zoom !== y && (k.innerHTML = "", k.style.cssText = "padding:0;margin:0;border:0;display:block;box-sizing:content-box;-moz-box-sizing:content-box;-webkit-box-sizing:content-box;width:1px;padding:1px;display:inline;zoom:1", a.inlineBlockNeedsLayout = 3 === k.offsetWidth, k.style.display = "block", k.innerHTML = "<div></div>", k.firstChild.style.width = "5px", a.shrinkWrapBlocks = 3 !== k.offsetWidth, a.inlineBlockNeedsLayout && (d.style.zoom = 1)), d.removeChild(b), k = null)
        });
        b = e = d = f = d = b = null;
        return a
    } ();
        ...
        data: function(a, b) {
            ...
            if (a === n) {
                if (this.length && (h = c.data(f), 1 === f.nodeType && !c._data(f, "parsedAttrs"))) {
                    for (d = f.attributes; g < d.length; g++) e = d[g].name,
                    e.indexOf("data-") || (e = c.camelCase(e.slice(5)), Va(f, e, h[e]));
    ...
    c.extend({
        ...
        dequeue: function(a, b) {
            ...
            if (g.cur = f)"fx" === b && d.unshift("inprogress"),
            delete g.stop,
            f.call(a, h, g); ! e && g && g.empty.fire()
        },
    ...
    c.fn.extend({
        ...
        toggleClass: function(a, b) {
            ...
            return c.isFunction(a) ? this.each(function(d) {
                ...
                h = c(this), k = b, l = a.match(O) || []; f = l[g++];) k = e ? k: !h.hasClass(f),
                h[k ? "addClass": "removeClass"](f);
                else if (d === y || "boolean" === d) this.className && c._data(this, "__className__", this.className),
        ...
        hasClass: function(a) {
            a = " " + a + " ";
            for (var b = 0,
            c = this.length; b < c; b++) if (1 === this[b].nodeType && 0 <= (" " + this[b].className + " ").replace(Fa, " ").indexOf(a)) return ! 0;
            return ! 1
        },
        val: function(a) {
            var b, d, e, f = this[0];
            ...
            this.each(function(b) {
                var f = c(this);
                1 === this.nodeType && (b = e ? a.call(this, b, f.val()) : a, null == b ? b = "": "number" === typeof b ? b += "": c.isArray(b) && (b = c.map(b,
                function(a) {
                    return null == a ? "": a + ""
    ...
    c.extend({
        valHooks: {
            ...
            select: {
                get: function(a) {
                    ...
                    e = a.selectedIndex,
                    f = (a = "select-one" === a.type || 0 > e) ? null: [], g = a ? e + 1 : d.length, h = 0 > e ? g: a ? e: 0; h < g; h++) if (b = d[h], !(!b.selected && h !== e || (c.support.optDisabled ? b.disabled: null !== b.getAttribute("disabled")) || b.parentNode.disabled && c.nodeName(b.parentNode, "optgroup"))) {
                        b = c(b).val();
                        if (a) return b;
                        f.push(b)
                    }
        ...
        attr: function(a, b, d) {
            ...
            if (a && 3 !== f && 8 !== f && 2 !== f) {
                ...
                if (f = 1 !== f || !c.isXMLDoc(a)) b = b.toLowerCase(),
                e = c.attrHooks[b] || (xb.test(b) ? wb: Z);
        ...
        removeAttr: function(a, b) {
            ...
            xb.test(d) ? !B && Ga.test(d) ? a[c.camelCase("default-" + d)] = a[e] = !1 : a[e] = !1 : c.attr(a, d, ""),
            a.removeAttribute(B ? d: e)
        },
        attrHooks: {
            type: {
                set: function(a, b) {
        ...
        prop: function(a, b, d) {
            ...
            g = a.nodeType;
            if (a && 3 !== g && 8 !== g && 2 !== g) {
                if (g = 1 !== g || !c.isXMLDoc(a)) b = c.propFix[b] || b,
                f = c.propHooks[b];
                return d !== n ? f && "set" in f && (e = f.set(a, d, b)) !== n ? e: a[b] = d: f && "get" in f && null !== (e = f.get(a, b)) ? e: a[b]
            }
        },
        propHooks: {
            tabIndex: {
    ...
    wb = {
        ...
        set: function(a, b, d) { ! 1 === b ? c.removeAttr(a, d) : Ha && B || !Ga.test(d) ? a.setAttribute(!B && c.propFix[d] || d, d) : a[c.camelCase("default-" + d)] = a[d] = !0;
            return d
        }
    };
    ...
    c.event = {
        ...
        add: function(a, b, d, e, f) {
            var g, h, k, l, q, s, m, u, p;
            if (k = c._data(a)) {
                d.handler && (l = d, d = l.handler, f = l.selector);
                d.guid || (d.guid = c.guid++); (h = k.events) || (h = k.events = {}); (q = k.handle) || (q = k.handle = function(a) {
                    return typeof c === y || a && c.event.triggered === a.type ? n: c.event.dispatch.apply(q.elem, arguments)
                },
                q.elem = a);
                b = (b || "").match(O) || [""];
                for (k = b.length; k--;) g = zb.exec(b[k]) || [],
                u = s = g[1],
                p = (g[2] || "").split(".").sort(),
                g = c.event.special[u] || {},
                u = (f ? g.delegateType: g.bindType) || u,
                g = c.event.special[u] || {},
                s = c.extend({
                    type: u,
                    origType: s,
                ...
                l),
                (m = h[u]) || (m = h[u] = [], m.delegateCount = 0, g.setup && !1 !== g.setup.call(a, e, p, q) || (a.addEventListener ? a.addEventListener(u, q, !1) : a.attachEvent && a.attachEvent("on" + u, q))),
                g.add && (g.add.call(a, s), s.handler.guid || (s.handler.guid = d.guid)),
        ...
        remove: function(a, b, d, e, f) {
            ...
            if (z && (n = z.events)) {
                ...
                for (q = b.length; q--;) if (k = zb.exec(b[q]) || [], E = A = k[1], r = (k[2] || "").split(".").sort(), E) {
                    ...
                    p = n[E] || [];
                    k = k[2] && RegExp("(^|\\.)" + r.join("\\.(?:.*\\.|)") + "(\\.|$)");
                    for (l = g = p.length; g--;) h = p[g],
                    !f && A !== h.origType || d && d.guid !== h.guid || k && !k.test(h.namespace) || e && !(e === h.selector || "**" === e && h.selector) || (p.splice(g, 1), h.selector && p.delegateCount--, m.remove && m.remove.call(a, h));
                    l && !p.length && (m.teardown && !1 !== m.teardown.call(a, r, z.handle) || c.removeEvent(a, E, z.handle), delete n[E])
        ...
        trigger: function(a, b, d, e) {
            ...
            h = f = d = d || p;
            if (3 !== d.nodeType && 8 !== d.nodeType && !yb.test(m + c.event.triggered) && (0 <= m.indexOf(".") && (l = m.split("."), m = l.shift(), l.sort()), g = 0 > m.indexOf(":") && "on" + m, a = a[c.expando] ? a: new c.Event(m, "object" === typeof a && a), a.isTrigger = !0, a.namespace = l.join("."), a.namespace_re = a.namespace ? RegExp("(^|\\.)" + l.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, a.result = n, a.target || (a.target = d), b = null == b ? [a] : c.makeArray(b, [a]), l = c.event.special[m] || {},
            e || !l.trigger || !1 !== l.trigger.apply(d, b))) {
                if (!e && !l.noBubble && !c.isWindow(d)) {
                    k = l.delegateType || m;
                    yb.test(k + m) || (h = h.parentNode);
                    for (; h; h = h.parentNode) s.push(h),
                    f = h;
                ...
                a.type = m;
                if (! (e || a.isDefaultPrevented() || l._default && !1 !== l._default.apply(d.ownerDocument, b) || "click" === m && c.nodeName(d, "a")) && c.acceptData(d) && g && d[m] && !c.isWindow(d)) { (f = d[g]) && (d[g] = null);
                    c.event.triggered = m;
                    try {
                        d[m]()
                    } catch(u) {}
        ...
        dispatch: function(a) {
            ...
            if (!k.preDispatch || !1 !== k.preDispatch.call(this, a)) {
                ...
                for (b = 0; (e = g[b++]) && !a.isPropagationStopped();) for (a.currentTarget = e.elem, f = 0; (d = e.handlers[f++]) && !a.isImmediatePropagationStopped();) if (!a.namespace_re || a.namespace_re.test(d.namespace)) a.handleObj = d,
                a.data = d.data,
        ...
        handlers: function(a, b) {
            ...
            if (k && l.nodeType && (!a.button || "click" !== a.type)) for (; l != this; l = l.parentNode || this) if (1 === l.nodeType && (!0 !== l.disabled || "click" !== a.type)) {
                ...
                for (g = 0; g < k; g++) e = b[g],
                d = e.selector + " ",
                f[d] === n && (f[d] = e.needsContext ? 0 <= c(d, this).index(l) : c.find(d, this, null, [l]).length),
                f[d] && f.push(e);
                f.length && h.push({
                    elem: l,
                    handlers: f
        ...
        special: {
            ...
            blur: {
                trigger: function() {
                    if (this === p.activeElement && this.blur) return this.blur(),
                    !1
                },
    ...
    function(a, b) {
        c.event.special[a] = {
            ...
            handle: function(a) {
                ...
                g = a.handleObj;
                if (!f || f !== this && !c.contains(this, f)) a.type = g.origType,
    ...
    c.support.submitBubbles || (c.event.special.submit = {
        setup: function() {
            ...
            function(a) {
                a = a.target; (a = c.nodeName(a, "input") || c.nodeName(a, "button") ? a.form: n) && !c._data(a, "submitBubbles") && (c.event.add(a, "submit._submit",
                function(a) {
                    a._submit_bubble = !0
    ...
    c.support.changeBubbles || (c.event.special.change = {
        setup: function() {
            ...
            function(a) {
                a = a.target;
                Ia.test(a.nodeName) && !c._data(a, "changeBubbles") && (c.event.add(a, "change._change",
    ...
    c.fn.extend({
        ...
        function h(a, b, c, d) {
            var e, f, g, h, k; (b ? b.ownerDocument || b: ha) !== K && oa(b);
            b = b || K;
            c = c || [];
            ...
            if (!x && !d) {
                if (e = ka.exec(a)) if (g = e[1]) if (9 === h) if ((f = b.getElementById(g)) && f.parentNode) {
                    ...
                    if (b.ownerDocument && (f = b.ownerDocument.getElementById(g)) && I(b, f) && f.id === g) return c.push(f),
                    c
                } else {
                    if (e[2]) return G.apply(c, J.call(b.getElementsByTagName(a), 0)),
                    c;
                    if ((g = e[3]) && C.getByClassName && b.getElementsByClassName) return G.apply(c, J.call(b.getElementsByClassName(g), 0)),
                    c
                }
                if (C.qsa && !V.test(a)) {
                    e = !0;
                    ...
                    if (1 === h && "object" !== b.nodeName.toLowerCase()) {
                        h = m(a); (e = b.getAttribute("id")) ? f = e.replace(na, "\\$&") : b.setAttribute("id", f);
                        f = "[id='" + f + "'] ";
                    ...
                    if (k) try {
                        return G.apply(c, J.call(g.querySelectorAll(k), 0)),
                        c
                    } catch(l) {} finally {
            ...
            a: {
                ...
                if (!d && 1 === f.length) {
                    e = f[0] = f[0].slice(0);
                    if (2 < e.length && "ID" === (q = e[0]).type && 9 === b.nodeType && !x && t.relative[e[1].type]) {
        ...
        function m(a, b) {
            ...
            k = [];
            for (l = t.preFilter; g;) {
                if (!c || (d = ea.exec(g))) d && (g = g.slice(d[0].length) || g),
                k.push(e = []);
                c = !1;
                if (d = fa.exec(g)) c = d.shift(),
                e.push({
                    value: c,
                    type: d[0].replace(P, " ")
                }),
            ...
            return f(function(f, g, k, l) {
                ...
                if (f) {
                    if (e || a) {
                        if (e) {
                            m = [];
                            for (k = u.length; k--;)(q = u[k]) && m.push(r[k] = q);
                            e(null, u = [], m, l)
                        }
                        for (k = u.length; k--;)(q = u[k]) && -1 < (m = e ? T.call(f, q) : n[k]) && (f[m] = !(g[m] = q))
                    }
                } else u = A(u === g ? u.splice(s, u.length) : u),
                e ? e(null, g, u, l) : G.apply(g, u)
            })
        }
        function y(a) {
            ...
            }]; g < e; g++) if (c = t.relative[a[g].type]) l = [r(z(l), c)];
            else {
        ...
        oa = h.setDocument = function(a) {
            ...
            t.find.TAG = C.tagNameNoComments ?
            function(a, b) {
            ...
            g(function(a) {
                ...
                V.push(",.*:")
            }); (C.matchesSelector = d(H = N.matchesSelector || N.mozMatchesSelector || N.webkitMatchesSelector || N.oMatchesSelector || N.msMatchesSelector)) && g(function(a) {
            ...
            V = RegExp(V.join("|"));
            sa = RegExp(sa.join("|"));
            I = d(N.contains) || N.compareDocumentPosition ?
            function(a, b) {
        ...
        h.matchesSelector = function(a, b) { (a.ownerDocument || a) !== K && oa(a);
            b = b.replace(ta, "='$1']");
        ...
        h.contains = function(a, b) { (a.ownerDocument || a) !== K && oa(a);
            return I(a, b)
        };
        h.attr = function(a, b) {
            var c; (a.ownerDocument || a) !== K && oa(a);
            x || (b = b.toLowerCase());
        ...
        t = h.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(a) {
                    ...
                    a[4] ? a[2] = a[4] : c && ga.test(c) && (b = m(c, !0)) && (b = c.indexOf(")", c.length - b) - c.length) && (a[0] = a[0].slice(0, b), a[2] = c.slice(0, b));
                    return a.slice(0, 3)
                }
            },
            filter: {
                ...
                CHILD: function(a, b, c, d, e) {
                    ...
                    function(a) {
                        ...
                        if (s) {
                            if (f) {
                                for (; c;) {
                                    for (m = b; m = m[c];) if (h ? m.nodeName.toLowerCase() === u: 1 === m.nodeType) return ! 1;
                            ...
                            else for (; (m = ++n && m && m[c] || (q = n = 0) || p.pop()) && ((h ? m.nodeName.toLowerCase() !== u: 1 !== m.nodeType) || !++q || (k && ((m[w] || (m[w] = {}))[a] = [D, q]), m !== b)););
                            q -= e;
                ...
                PSEUDO: function(a, b) {
                    ...
                    return d[w] ? d(b) : 1 < d.length ? (c = [a, a, "", b], t.setFilters.hasOwnProperty(a.toLowerCase()) ? f(function(a, c) {
                        for (var e, f = d(a, b), g = f.length; g--;) e = T.call(a, f[g]),
                        a[e] = !(c[e] = f[g])
                    }) : function(a) {
                        return d(a, 0, c)
                    }) : d
            ...
            pseudos: {
                ...
                lang: f(function(a) {
                    ...
                    return function(b) {
                        var c;
                        do
                        if (c = x ? b.getAttribute("xml:lang") || b.getAttribute("lang") : b.lang) return c = c.toLowerCase(),
                        c === a || 0 === c.indexOf(a + "-");
        ...
        Ka = h.compile = function(a, b) {
            ...
            if (!f) {
                b || (b = m(a));
                for (c = b.length; c--;) f = y(b[c]),
                f[w] ? d.push(f) : e.push(f);
                f = S(a, O(e, d))
            }
            return f
        };
    ...
    c.fn.extend({
        find: function(a) {
            ...
            if ("string" !== typeof a) return e = this,
        ...
        not: function(a) {
            return this.pushStack(Xa(this, a, !1))
        },
        filter: function(a) {
        ...
        closest: function(a, b) {
            for (var d, e = 0,
            f = this.length,
            g = [], h = Bb.test(a) || "string" !== typeof a ? c(a, b || this.context) : 0; e < f; e++) for (d = this[e]; d && d.ownerDocument && d !== b && 11 !== d.nodeType;) {
    ...
    c.fn.extend({
        ...
        remove: function(a, b) {
            for (var d, e = 0; null != (d = this[e]); e++) if (!a || 0 < c.filter(a, [d]).length) b || 1 !== d.nodeType || c.cleanData(A(d)),
            d.parentNode && (b && c.contains(d.ownerDocument, d) && ya(A(d, "script")), d.parentNode.removeChild(d));
            return this
        },
        empty: function() {
        ...
        html: function(a) {
            ...
            function(a) {
                ...
                e = 0,
                f = this.length;
                if (a === n) return 1 === d.nodeType ? d.innerHTML.replace(uc, "") : n;
        ...
        domManip: function(a, b, d) {
            ...
            if (l && (h = c.buildFragment(a, this[0].ownerDocument, !1, this), e = h.firstChild, 1 === h.childNodes.length && (h = e), e)) {
                ...
                for (f = g.length; k < l; k++) e = h,
                k !== p && (e = c.clone(e, !0, !0), f && c.merge(g, A(e, "script"))),
                d.call(b && c.nodeName(this[k], "table") ? this[k].getElementsByTagName("tbody")[0] || this[k].appendChild(this[k].ownerDocument.createElement("tbody")) : this[k], e, k);
                if (f) for (h = g[g.length - 1].ownerDocument, c.map(g, ab), k = 0; k < f; k++) e = g[k],
                Gb.test(e.type || "") && !c._data(e, "globalEval") && c.contains(h, e) && (e.src ? c.ajax({
                    url: e.src,
                    type: "GET",
                    dataType: "script",
                    async: !1,
    ...
    function(a, b) {
        c.fn[a] = function(a) {
            for (var e = 0,
            f = [], g = c(a), h = g.length - 1; e <= h; e++) a = e === h ? this: this.clone(!0),
            c(g[e])[b](a),
            Da.apply(f, a.get());
            return this.pushStack(f)
        }
    ...
    c.extend({
        clone: function(a, b, d) {
            ...
            c.support.html5Clone || c.isXMLDoc(a) || !Cb.test("<" + a.nodeName + ">") ? g = a.cloneNode(!0) : (Ma.innerHTML = a.outerHTML, Ma.removeChild(g = Ma.firstChild));
            if (! (c.support.noCloneEvent && c.support.noCloneChecked || 1 !== a.nodeType && 11 !== a.nodeType || c.isXMLDoc(a))) for (e = A(g), k = A(a), h = 0; null != (f = k[h]); ++h) if (e[h]) {
                ...
                if (1 === q.nodeType) {
                    ...
                    if ("script" === n && q.text !== f.text) $a(q).text = f.text,
                    ab(q);
                    else if ("object" === n) q.parentNode && (q.outerHTML = f.outerHTML),
                    c.support.html5Clone && f.innerHTML && !c.trim(q.innerHTML) && (q.innerHTML = f.innerHTML);
                    else if ("input" === n && za.test(f.type)) q.defaultChecked = q.checked = f.checked,
                    q.value !== f.value && (q.value = f.value);
                    else if ("option" === n) q.defaultSelected = q.selected = f.defaultSelected;
                    else if ("input" === n || "textarea" === n) q.defaultValue = f.defaultValue
                }
            }
            if (b) if (d) for (k = k || A(a), e = e || A(g), h = 0; null != (f = k[h]); h++) bb(f, e[h]);
            else bb(a, g);
            e = A(g, "script");
        ...
        buildFragment: function(a, b, d, e) {
            for (var f, g, h, k, l, q, n = a.length,
            m = Ya(b), p = [], r = 0; r < n; r++) if ((g = a[r]) || 0 === g) if ("object" === c.type(g)) c.merge(p, g.nodeType ? [g] : g);
            else if (vc.test(g)) {
                h = h || m.appendChild(b.createElement("div"));
                k = (Eb.exec(g) || ["", ""])[1].toLowerCase();
                q = F[k] || F._default;
                h.innerHTML = q[1] + g.replace(Db, "<$1></$2>") + q[2];
                for (f = q[0]; f--;) h = h.lastChild; ! c.support.leadingWhitespace && La.test(g) && p.push(b.createTextNode(La.exec(g)[0]));
                if (!c.support.tbody) for (f = (g = "table" !== k || Fb.test(g) ? "<table>" !== q[1] || Fb.test(g) ? 0 : h: h.firstChild) && g.childNodes.length; f--;) c.nodeName(l = g.childNodes[f], "tbody") && !l.childNodes.length && g.removeChild(l);
            ...
            for (r = 0; g = p[r++];) if (!e || -1 === c.inArray(g, e)) if (a = c.contains(g.ownerDocument, g), h = A(m.appendChild(g), "script"), a && ya(h), d) for (f = 0; g = h[f++];) Gb.test(g.type || "") && d.push(g);
            return m
        },
        cleanData: function(a, b) {
            ...
            k = c.expando,
            l = c.cache,
            q = c.support.deleteExpando,
            n = c.event.special; null != (d = a[h]); h++) if (b || c.acceptData(d)) if (g = (f = d[k]) && l[f]) {
    ...
    c.fn.extend({
        ...
        toggle: function(a) {
            ...
            return this.each(function() { (b ? a: P(this)) ? c(this).show() : c(this).hide()
            })
        }
    });
    c.extend({
        ...
        css: function(a, b, d, e) {
            var f, g;
            g = c.camelCase(b);
            b = c.cssProps[g] || (c.cssProps[g] = cb(a.style, g)); (g = c.cssHooks[b] || c.cssHooks[g]) && "get" in g && (f = g.get(a, !0, d));
            f === n && (f = S(a, b, e));
    ...
    r.getComputedStyle ? (R = function(a) {
    ...
    function(a, b) {
        c.cssHooks[b] = {
            get: function(a, e, f) {
                if (e) return 0 === a.offsetWidth && Bc.test(c.css(a, "display")) ? c.swap(a, Dc,
                function() {
                    return ib(a, b, f)
                }) : ib(a, b, f)
            },
        ...
        ajax: function(a, b) {
            function d(a, b, d, e) {
                ...
                if (2 !== M) {
                    ...
                    if (d) {
                        ...
                        for (;
                        "*" === w[0];) w.shift(),
                        y === n && (y = t.mimeType || e.getResponseHeader("Content-Type"));
                    ...
                    if (200 <= a && 300 > a || 304 === a) if (m.ifModified && ((d = v.getResponseHeader("Last-Modified")) && (c.lastModified[g] = d), (d = v.getResponseHeader("etag")) && (c.etag[g] = d)), 204 === a) f = !0,
                    x = "nocontent";
                    else if (304 === a) f = !0,
                    x = "notmodified";
                    else {
                        a: {
                            ...
                            for (; d = y[++B];) if ("*" !== d) {
                                if ("*" !== H && H !== d) {
                                    D = x[H + " " + d] || x["* " + d];
                                    if (!D) for (C in x) if (f = C.split(" "), f[1] === d && (D = x[H + " " + f[0]] || x["* " + f[0]])) { ! 0 === D ? D = x[C] : !0 !== x[C] && (d = f[0], y.splice(B--, 0, d));
                                        break
                                    }
                                    if (!0 !== D) if (D && p["throws"]) s = D(s);
                                    else try {
                                        s = D(s)
                                    } catch(L) {
                                        f = {
            ...
            v = {
                ...
                statusCode: function(a) {
                    var b;
                    if (a) if (2 > M) for (b in a) F[b] = [F[b], a[b]];
            ...
            null == m.crossDomain && (e = Lb.exec(m.url.toLowerCase()), m.crossDomain = !(!e || e[1] === aa[1] && e[2] === aa[2] && (e[3] || ("http:" === e[1] ? 80 : 443)) == (aa[3] || ("http:" === aa[1] ? 80 : 443))));
            m.data && m.processData && "string" !== typeof m.data && (m.data = c.param(m.data, m.traditional));
            mb(Nb, m, b, v);
            if (2 === M) return v; (l = m.global) && 0 === c.active++&&c.event.trigger("ajaxStart");
            ...
            m.ifModified && (c.lastModified[g] && v.setRequestHeader("If-Modified-Since", c.lastModified[g]), c.etag[g] && v.setRequestHeader("If-None-Match", c.etag[g])); (m.data && m.hasContent && !1 !== m.contentType || b.contentType) && v.setRequestHeader("Content-Type", m.contentType);
            ...
            if (m.beforeSend && (!1 === m.beforeSend.call(r, v, m) || 2 === M)) return v.abort();
            G = "abort";
            for (f in {
                success: 1,
                error: 1,
    ...
    function(a, b, d) {
        ...
        if (h || "jsonp" === a.dataTypes[0]) return e = a.jsonpCallback = c.isFunction(a.jsonpCallback) ? a.jsonpCallback() : a.jsonpCallback,
        h ? a[h] = a[h].replace(Qa, "$1" + e) : !1 !== a.jsonp && (a.url += (Pa.test(a.url) ? "&": "?") + a.jsonp + "=" + e),
    ...
    c.support.cors = !!ia && "withCredentials" in ia; (ia = c.support.ajax = !!ia) && c.ajaxTransport(function(a) {
            ...
            return {
                send: function(d, e) {
                    ...
                    b = function(d, g) {
                        var k, m, p, r;
                        try {
                            if (b && (g || 4 === h.readyState)) if (b = n, f && (h.onreadystatechange = c.noop, Ra && delete X[f]), g) 4 !== h.readyState && h.abort();
                            else {
                                r = {};
                                k = h.status;
                    ...
                    a.async ? 4 === h.readyState ? setTimeout(b) : (f = ++Lc, Ra && (X || (X = {},
                    c(r).unload(Ra)), X[f] = b), h.onreadystatechange = b) : b()
                },
                abort: function() {
                    b && b(n, !0)
                }
    ...
    ja = [function(a, b, d) {
        ...
        for (f in b) g = b[f],
        Mc.exec(g) && (delete b[f], e = e || "toggle" === g, g !== (r ? "hide": "show") && p.push(f));
        ...
        h = q.createTween(e, r ? g[e] : 0),
        m[e] = g[e] || c.style(a, e),
        e in g || (g[e] = h.start, r && (h.end = h.start, h.start = "width" === e || "height" === e ? 1 : 0))
    }],
    fa = {
        "*": [function(a, b) {
    ...
    c.fn.extend({
        ...
        stop: function(a, b, d) {
            ...
            return this.each(function() {
                ...
                else for (g in k) k[g] && k[g].stop && Oc.test(g) && e(k[g]);
    ...
    c.fx.tick = function() {
        var a, b = c.timers,
        d = 0;
        for (T = c.now(); d < b.length; d++) a = b[d],
    ...
    c.offset = {
        setOffset: function(a, b, d) {
            ...
            k = c.css(a, "left"),
            l = {},
            n = {}; ("absolute" === e || "fixed" === e) && -1 < c.inArray("auto", [h, k]) ? (n = f.position(), e = n.top, k = n.left) : (e = parseFloat(h) || 0, k = parseFloat(k) || 0);
